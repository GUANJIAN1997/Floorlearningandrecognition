import json
import numpy as np
filepath = "/Users/jianguan/Desktop/毕业/楼层判定实验数据/test5.json"
        ...
        if deleted_upordown_number2[i] != "階層移動":
            ...
            for i in range(len(jiao_7)):
                ...
                if jiao_7[i]:
                    ...
                    # P_sum2 = round(P_sum  / len(learned_floor_dic[i]),6)
                    # P_sum2 = round(P_sum / len(jiao_7[i]), 6)
                    P_sum2 = round(P_sum  / len(jiao_7_number), 6)
